                ...
                <Flex justify="space-between">
                    ...
                    <Space>
                        <Typography.Text className="font-roboto text-gray-900 font-medium">
                            ₹ {useFormatPrice(subTotal)}
                        </Typography.Text>
                    </Space>
                </Flex>
                <Flex justify="space-between">
                    <Space>
                        <Typography.Text>GST (5%)</Typography.Text>
                    </Space>
                    <Space>
                        <Typography.Text className="font-roboto text-gray-900 font-medium">
                            ₹ {useFormatPrice(cartDetails?.totalVat)}
                        </Typography.Text>
                    </Space>
                </Flex>
                <Flex justify="space-between">
                    ...
                    <Space>
                        <Typography.Text className="font-roboto text-gray-900 font-medium">
                            {cartDetails.freeDelivery === true ? '₹ 0' : `₹ ${shipping}`}
                        </Typography.Text>
                    </Space>
                </Flex>
                <Flex justify="space-between">
                ...
                <Flex justify="space-between">
                    ...
                    <Space>
                        <Typography.Text strong className="font-roboto text-gray-900 font-medium">
                            ₹ {useFormatPrice(cartDetails?.grandTotal)}
                        </Typography.Text>
                    </Space>
                </Flex>
            </Flex>
