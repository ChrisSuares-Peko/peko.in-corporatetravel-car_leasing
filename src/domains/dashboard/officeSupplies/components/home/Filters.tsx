...
const Filters: FC<ProductListingProps> = ({
    ...
    <Flex vertical>
        ...
        {/* <Flex
            ...
            align="center"
            className="items-center w-full my-5 gap-2 "
        >
            
           
            <Flex className="hidden" align="center" gap={5} wrap="wrap">
                <Typography.Paragraph className="text-lg font-semibold mb-2 ">
                    Related:
                </Typography.Paragraph>
                <Flex gap={8}>
                    {dummyRelatedProducts.Desktops.map(item => (
                        <Button
                            size="small"
                            key={item.id}
                            type="text"
                            className="bg-gray-100 text-textBtnGray "
                        >
                            {item.name}
                        </Button>
                    ))}
