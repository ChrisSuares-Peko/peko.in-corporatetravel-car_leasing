...
const CardDetails = () => {
    ...
    const savedCards = useMemo(
        () => allCards && allCards.map(card => <SavedCard cardData={card} key={card.id} />),
        [allCards]
    );
        ...
        >
            <Flex vertical>
                <Flex justify="space-between">
                    <Text className="text-base font-medium">Payment Method</Text>
                    <Button
                        danger
                ...
                <Row className="gap-6 mt-4">
                    ...
                    <Col>
                        <Text className="text-base font-medium ">{defaultCard.maskedPan}</Text>
